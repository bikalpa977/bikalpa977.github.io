...
function map() {
    ...
    var mapId = 'map',
        mapCenter = [27.700086894561274, 85.2697291767242],
        mapMarker = true;
    ...
    if ($('#' + mapId).length > 0) {
        ...
        if (mapMarker) {
            ...
            marker.bindPopup("<div class='p-4'><h5>About this location</h5><p>This is a location, where I live. It is Nagarjun-10, Kathmandu, Nepal, Annapurna Tole.</p></div>", {
                minwidth: 200,
                maxWidth: 600,
